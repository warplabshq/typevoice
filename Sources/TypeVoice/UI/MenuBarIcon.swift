...
enum MenuBarIcon {
    ...
    static let image = BrandWave.image(height: 16, barWidth: 1.5)
    static let listening = BrandWave.image(height: 16, barWidth: 1.5, heights: listeningHeights)
    static let processing = BrandWave.image(height: 16, barWidth: 1.5, alpha: 0.42)
    static let paused = BrandWave.image(height: 16, barWidth: 1.5, alpha: 0.55, heights: BrandWave.heights.map { $0 * 0.55 })
